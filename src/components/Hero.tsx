      ...
      <div className="container mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid items-center gap-12 lg:grid-cols-5">
          <div className="lg:col-span-3">
            <h1 className="mb-6 text-4xl font-bold leading-tight text-primary md:text-5xl lg:text-[56px] lg:leading-[1.1]">
              Stop Competing for Bad MCA Leads. Start Converting with a Scalability Partner.
            </h1>
            <p className="mb-8 text-lg text-text-secondary md:text-xl lg:leading-relaxed">
